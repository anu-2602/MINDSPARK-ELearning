  ...
  <div class="c">
    <div class="main-container">
        ...
        <div class="right-side">
            <h2><?php echo htmlspecialchars($user['id'] . '  : ' . $user['course_title']); ?></h2>
            <p>
                <img src="https://img.icons8.com/ios-filled/50/2575fc/user-male-circle.png" alt="User Icon" class="icon">
                <strong>Course Title:</strong> <?php echo htmlspecialchars($user['course_title']); ?>
            </p>
            <p>
                <img src="https://img.icons8.com/ios-filled/50/2575fc/user-male-circle.png" alt="User Icon" class="icon">
                <strong>Course Category:</strong> <?php echo htmlspecialchars($user['course_category']); ?>
            </p>
            <p>
                <img src="https://img.icons8.com/ios-filled/50/2575fc/username.png" alt="Username Icon" class="icon">
                <strong>Course Description:</strong> <?php echo htmlspecialchars($user['course_description']); ?>
            </p>
            <p>
                <img src="https://img.icons8.com/ios-filled/50/2575fc/email.png" alt="Email Icon" class="icon">
                <strong>Course Thumbnail:</strong> <a href="../uploads/<?php echo htmlspecialchars($user['course_thumbnail']); ?>">course Thumbnail</a>

               
            </p>
            <p>
                <img src="https://img.icons8.com/ios-filled/50/2575fc/password.png" alt="Password Icon" class="icon">
                <strong>Video Link:</strong><a href="<?php echo htmlspecialchars($user['video_link']); ?>">Video Link</a>
            </p>
            <p>
                <img src="https://img.icons8.com/?size=96&id=PISUap0mXhs3&format=png" alt="Password Icon" class="icon">
                <strong>pdf File  Notes:</strong> <a href="../uploads/<?php echo htmlspecialchars($user['pdfFileInput']); ?>">Pdf File</a>
            </p>
            <p>
                <img src="https://img.icons8.com/?size=96&id=PISUap0mXhs3&format=png" alt="Password Icon" class="icon">
                <strong>Hand Written Notes:</strong><a href=" ../uploads/<?php echo htmlspecialchars($user['handwrittenFileInput']); ?>">Handwritten Notes</a>
            </p>
