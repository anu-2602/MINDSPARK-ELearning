...
$sql = "SELECT id, course_title, course_category, course_description, course_thumbnail, video_link, pdfFileInput, handwrittenFileInput FROM addcourse";
            ...
            <?php if ($results->num_rows > 0): ?>
                <?php while($row = $results->fetch_assoc()): ?>
                    ...
                    <td><?php echo $row['id']; ?></td>
                        ...
                        <td><a href="../uploads/<?php echo $row['course_thumbnail']; ?>">thumbnail</a></td>
                        <td><a href="../uploads/<?php echo $row['video_link']; ?>">Video link</a></td>
                        <td><a href="../uploads/<?php echo $row['pdfFileInput']; ?>">Pdf File</a></td>
                        <td><a href="../uploads/<?php echo $row['handwrittenFileInput']; ?>">Handwritten Notes</a></td>
                        <td><a href="courseview.php?id=<?php echo $row['id']; ?>">View</a></td>
                    </tr>
                <?php endwhile; ?>
            <?php else: ?>
                <tr>
