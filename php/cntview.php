  ...
  <div class="c">
    <div class="main-container">
        ...
        <div class="right-side">
            <h2><?php echo htmlspecialchars($user['id'] . ' : ' . $user['name']); ?></h2>
            <p>
            ...
            <p>
                ...
                <strong>Interest:</strong> <?php echo htmlspecialchars($user['interest']); ?>
            </p>
            <p>
                <img src="https://img.icons8.com/?size=96&id=D6fq9I7xyv5X&format=png" alt="Password Icon" class="icon">
                <strong>Message:</strong> <?php echo htmlspecialchars($user['message']); ?>
            </p>
        </div>
    </div>
